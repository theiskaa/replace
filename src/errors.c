...
const char *helpText =
    "Usage: rp [OPTIONS] [TARGET] [REPLACE] [FILES]...\n"
    "The 'rp' command is a versatile tool for efficiently replacing content "
    "within specified files.\n\n"
    "Options:\n"
    "  -w, --word      Perform word-based replacements (exact, space-free "
    "match)\n\n"
    "Arguments:\n"
    ...
    "will be applied\n\n"
    "Examples:\n"
    "  rp -w \"color\" \"colour\" \"folder_name/*.md\"\n"
    "     Replace all exact occurrences of the word \"color\" with \"colour\" "
    "in Markdown "
    "files within 'folder_name'.\n"
    "  rp \"old_text\" \"new_text\" \"file.txt\"\n"
    "     Replace \"old_text\" with \"new_text\" in 'file.txt'.\n"
    "  rp -w \"typo\" \"correction\" \"*.txt\"\n"
    "     Replace all exact occurrences of the word \"typo\" with "
    "\"correction\" in all text files in the "
    "current directory.\n\n"
    "Notes:\n"
